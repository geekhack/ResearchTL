...
train_df = pd.read_csv("reduced_flowers_data.csv")
...
history2 = t_model.fit(validation_dataset, batch_size=32, epochs=10, verbose=1)
...
# load the image
images_array = ['145862135_ab710de93c_n.jpg', '21652746_cc379e0eea_m.jpg'];
