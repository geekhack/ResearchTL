...
csv_file = "csv/reduced_cubs_data_filter5.csv"
filepath = "train/"
new_path_prefix = 'augmented/Raw_cubs/'
with open(csv_file, 'r') as f:
    ...
    df.to_csv('csv/raw_augmented_cubs.csv', index=False)

#get the files
folder = 'augmented/processed_cubs'
images_array = []
...
df = pd.DataFrame(x)
df.columns = ['file', 'label', 'class_id']
df.to_csv('csv/processed_augmented_cubs.csv', index=False)
...
csv_file = "csv/raw_augmented_cubs.csv"
